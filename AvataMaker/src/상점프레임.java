...
public class 상점프레임 {
	...
	private void initialize() {
		...
		ImageIcon 상점캐릭터 = new ImageIcon("농담곰_상점_기본.png");//대표캐릭터가 보이는 라벨//적용버튼 만들기//보유포인트라벨 만들기

		JButton btnNewButton_1 = new JButton("New button"); //새창이뜸 //착샷이뜸//구매하기 ,입기벗기,닫기
