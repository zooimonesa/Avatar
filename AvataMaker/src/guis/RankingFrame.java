...
public class RankingFrame {
	...
	private void initialize() {
		...
		panel.setBorder(new TitledBorder(null, "체력랭킹", TitledBorder.LEADING, TitledBorder.TOP,
				new Font("경기천년제목 Bold", Font.PLAIN, 15), null));
		...
		panel_1.setBorder(new TitledBorder(null, "지능랭킹", TitledBorder.LEADING, TitledBorder.TOP,
				new Font("경기천년제목 Bold", Font.PLAIN, 15), null));
		...
		panel_2.setBorder(new TitledBorder(null, "재능랭킹", TitledBorder.LEADING, TitledBorder.TOP,
				new Font("경기천년제목 Bold", Font.PLAIN, 15), null));
